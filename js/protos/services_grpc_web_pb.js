 ...
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.modelzoo.Empty,
 *   !proto.modelzoo.ListTestsResponse>}
 */
const methodDescriptor_ModelzooService_ListTests = new grpc.web.MethodDescriptor(
  '/modelzoo.ModelzooService/ListTests',
  grpc.web.MethodType.UNARY,
  proto.modelzoo.Empty,
  proto.modelzoo.ListTestsResponse,
  /**
  ...
  proto.modelzoo.ListTestsResponse.deserializeBinary
);
 ...
 *   !proto.modelzoo.ListTestsResponse>}
 */
const methodInfo_ModelzooService_ListTests = new grpc.web.AbstractClientBase.MethodInfo(
  proto.modelzoo.ListTestsResponse,
  /**
   * @param {!proto.modelzoo.Empty} request
   * @return {!Uint8Array}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.modelzoo.ListTestsResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.modelzoo.ListTestsResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.modelzoo.ModelzooServiceClient.prototype.listTests =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/modelzoo.ModelzooService/ListTests',
      request,
      metadata || {},
      methodDescriptor_ModelzooService_ListTests,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.modelzoo.ListTestsResponse>}
 *     A native promise that resolves to the response
 */
proto.modelzoo.ModelzooServicePromiseClient.prototype.listTests =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/modelzoo.ModelzooService/ListTests',
      request,
 ...
 *   !proto.modelzoo.Empty>}
 */
const methodDescriptor_ModelzooService_CreateTest = new grpc.web.MethodDescriptor(
  '/modelzoo.ModelzooService/CreateTest',
  grpc.web.MethodType.UNARY,
  proto.modelzoo.Test,
  proto.modelzoo.Empty,
  /**
   * @param {!proto.modelzoo.Test} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
 ...
 *   !proto.modelzoo.Empty>}
 */
const methodInfo_ModelzooService_CreateTest = new grpc.web.AbstractClientBase.MethodInfo(
  proto.modelzoo.Empty,
  /**
   * @param {!proto.modelzoo.Test} request
   * @return {!Uint8Array}
...
/**
 * @param {!proto.modelzoo.Test} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.modelzoo.Empty)}
 ...
 *     The XHR Node Readable Stream
 */
proto.modelzoo.ModelzooServiceClient.prototype.createTest =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/modelzoo.ModelzooService/CreateTest',
      request,
      metadata || {},
      methodDescriptor_ModelzooService_CreateTest,
      callback);
};
 ...
 *     A native promise that resolves to the response
 */
proto.modelzoo.ModelzooServicePromiseClient.prototype.createTest =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/modelzoo.ModelzooService/CreateTest',
      request,
